...
Source0  : https://files.pythonhosted.org/packages/bb/f9/a526ea001ecadd48d90ed7a61038b5ba732136d76b60357d23dc37521c58/pybind11-2.10.4.tar.gz
...
%prep
%setup -q -n pybind11-2.10.4
cd %{_builddir}/pybind11-2.10.4
pushd ..
cp -a pybind11-2.10.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679065546
