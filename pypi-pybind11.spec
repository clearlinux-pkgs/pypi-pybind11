...
Source0  : https://files.pythonhosted.org/packages/2f/23/aaf147a5bc31c8be286f07d862b3699d7b49e3411fb75087525b5c31ab3e/pybind11-2.10.1.tar.gz
...
%prep
%setup -q -n pybind11-2.10.1
cd %{_builddir}/pybind11-2.10.1
pushd ..
cp -a pybind11-2.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667251459
