...
%prep
%setup -q -n pybind11-2.9.2
cd %{_builddir}/pybind11-2.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650558105
...
cp %{_builddir}/pybind11-2.9.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pybind11/3dbd61e2b2c71dcc658c3da90bacf2e15958075a
