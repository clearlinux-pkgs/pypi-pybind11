...
Source0  : https://files.pythonhosted.org/packages/56/d3/ebc2ad811d192b91d97a45d30b4d5bcb148275db668eada4b6f55781fdc7/pybind11-2.10.3.tar.gz
...
%prep
%setup -q -n pybind11-2.10.3
cd %{_builddir}/pybind11-2.10.3
pushd ..
cp -a pybind11-2.10.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672785458
