...
Version  : 2.9.0
Release  : 36
URL      : https://files.pythonhosted.org/packages/55/08/20f915ceea974f9e6a4aa61b515dac84befda136c4d03a873550f19540cf/pybind11-2.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/55/08/20f915ceea974f9e6a4aa61b515dac84befda136c4d03a873550f19540cf/pybind11-2.9.0.tar.gz
...
Provides: pybind11
Provides: pybind11-python
Provides: pybind11-python3
...
%prep
%setup -q -n pybind11-2.9.0
cd %{_builddir}/pybind11-2.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641473250
...
cp %{_builddir}/pybind11-2.9.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pybind11/3dbd61e2b2c71dcc658c3da90bacf2e15958075a
